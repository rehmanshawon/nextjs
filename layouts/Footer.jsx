...
const Footer = () => {
  return (
    <footer className="main">
              ...
              <div className="row align-items-center">
                <div className="col flex-horizontal-center">
                  <img
                    ...
                    src="/assets/frontend/imgs/theme/icons/icon-email.svg"
                    alt=""
                  />
            ...
            <div className="col-lg-4 col-md-6">
              <div className="widget-about font-md mb-md-5 mb-lg-0">
                ...
                <p className="wow fadeIn animated">
                  <strong>Address: </strong>House#1037 , Road #9 , Avenue#9 ,
                  Mirpur DOHS , Mirpur, Bangladesh, 1219
                </p>
                <p className="wow fadeIn animated">
                  <strong>Phone: </strong>(+880) 1763 - 851107
                </p>
                <p className="wow fadeIn animated">
                ...
                <div className="mobile-social-icon wow fadeIn animated mb-sm-5 mb-md-0">
                  ...
                  <a href="#">
                    <img
                      src="/assets/frontend/imgs/theme/icons/icon-youtube.svg"
                      alt=""
                    />
                  </a>
                </div>
                ...
                <div className="col-md-8 col-lg-12">
                  ...
                  <div className="download-app wow fadeIn animated">
                    <a href="#" className="hover-up mb-sm-4 mb-lg-0">
                      <img
                        className="active"
                        src="/assets/frontend/imgs/theme/app-store.jpg"
                        alt=""
                      />
                    </a>
                    <a href="#" className="hover-up">
                      <img
                        src="/assets/frontend/imgs/theme/google-play.jpg"
                        alt=""
                      />
                    </a>
                  </div>
                ...
                <div className="col-md-4 col-lg-12 mt-md-3 mt-lg-0">
                  ...
                  <div className="d-flex">
                    <img
                      ...
                      src="/assets/frontend/imgs/theme/payment-method.png"
                      alt=""
                    />
                    <img
                      className="wow fadeIn animated ms-2"
                      src="/imgs/Bkash-logo.png"
                      alt=""
                      style={{ height: "40px", width: "50px" }}
                    />
                    <img
                      className="wow fadeIn animated ms-2"
                      src="/imgs/Nagad-Logo.png"
                      alt=""
                      style={{ height: "40px", width: "50px" }}
                    />
                    <img
      ...
      <div className="pb-20 wow fadeIn animated footer-end">
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-6">
              <p className="float-md-left font-sm text-muted mb-0">
                &copy; 2021, <strong className="text-brand">Borna</strong> -
                Engineering{" "}
              </p>
            </div>
            <div className="col-lg-6">
              <p className="text-lg-end text-start font-sm text-muted mb-0">
                Designed by{" "}
                {/* <a href="https://rashed-abir.web.app" target="_blank">
                  Rashed Abir
                </a> */}
                Kopotron Systems Ltd. All rights reserved
              </p>
            </div>
          </div>
        </div>
