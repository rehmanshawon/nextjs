...
const Cart = () => {
  ...
  const [flatRate, setFlatRate] = React.useState(5);
  ...
  useEffect(() => {
    cartService.cart.subscribe({
      next(cart) {
        if (cart !== null) {
          setMyCart(cart.items);
          console.log("cartSub", cart);
          setCartTotal(cart.cartSubtotal);
          setShippingCharge((cart.cartSubtotal * flatRate) / 100);
          setTotal(cart.cartSubtotal + (cart.cartSubtotal * flatRate) / 100);
        } else {
          setMyCart([]);
          setCartTotal(0);
          setShippingCharge(0);
    ...
    // cartService.cartValue?.items?.length > 0 &&
    //   setMyCart(cartService.cartValue.items);
  }, []);
  return (
          ...
          <div className="col-12">
                            ...
                            <a
                              ...
                              onClick={async (e) => {
                                ...
                                if (temp[i].quantity > 1) {
                                  ...
                                  temp[i].subtotal =
                                    (temp[i].unit_price -
                                      temp[i].discount_amount) *
                                    temp[i].quantity;
                                }
                                setMyCart(temp);
                                await cartService.update(temp);
                              }}
                            >
            ...
            <div className="cart-action text-end">
              <a
                ...
                onClick={async (e) => {
                  await cartService.update(myCart);
                }}
              >
                        ...
                        >
                          <span className="selection">
                            <span
                              ...
                              aria-expanded="false"
                              tabIndex="0"
                              aria-labelledby="select2-0lti-container"
                            >
                              <span
                                className="select2-selection__rendered"
                                id="select2-0lti-container"
                                role="textbox"
                                aria-readonly="true"
                    ...
                    <table className="table">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td className="cart_total_amount">
                            {" "}
                            <i className="ti-gift mr-5"></i> {shippingCharge}
                          </td>
                        </tr>
                        <tr>
